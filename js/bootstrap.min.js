...
!function (t, e) {
    ...
    var a, l, c = function (t) {
        ...
        }, T = "rtl" === document.documentElement.dir, k = (a = {}, l = 1, {
            set: function (t, e, n) {
    ...
    function M(t, e, n) {
        var i = "string" == typeof e, o = i ? n : e, s = t.replace(S, ""), r = j[s];
    ...
    function R(t, e, n, i, o) {
        if ("string" == typeof e && t) {
            n || (n = i, i = null);
            var s = M(e, n, i), r = s[0], a = s[1], l = s[2], c = H(t), u = c[l] || (c[l] = {}),
                d = B(u, a, r ? n : null);
            if (d) d.oneOff = d.oneOff && o; else {
                var f = x(a, e.replace(D, "")), h = r ? function (t, e, n) {
                    return function i(o) {
                        for (var s = t.querySelectorAll(e), r = o.target; r && r !== this; r = r.parentNode) for (var a = s.length; a--;) if (s[a] === r) return o.delegateTarget = r, i.oneOff && Q.off(t, o.type, n), n.apply(r, [o]);
                        return null
                    }
                }(t, n, i) : function (t, e) {
                    return function n(i) {
    ...
    var Q = {
        on: function (t, e, n, i) {
            ...
            if ("string" == typeof e && t) {
                var o = M(e, n, i), s = o[0], r = o[1], a = o[2], l = a !== e, c = H(t), u = e.startsWith(".");
                if (void 0 === r) {
            ...
            var i, o = w(), s = e.replace(S, ""), r = e !== s, a = P.has(s), l = !0, c = !0, u = !1, d = null;
    ...
    var q = {
        ...
        }, $ = "carousel", G = ".bs.carousel",
        Z = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, J = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, tt = {TOUCH: "touch", PEN: "pen"}, et = function (t) {
            function e(e, n) {
                var i;
            ...
            return n.next = function () {
                ...
                var n = this._getItemIndex(t), i = this._getItemIndex(V.findOne(".active.carousel-item", this._element));
                ...
                var n, i, o, s = this, r = V.findOne(".active.carousel-item", this._element), a = this._getItemIndex(r),
                    l = e || r && this._getItemByDirection(t, r), c = this._getItemIndex(l), u = Boolean(this._interval);
                if ("next" === t ? (n = "carousel-item-start", i = "carousel-item-next", o = "left") : (n = "carousel-item-end", i = "carousel-item-prev", o = "right"), l && l.classList.contains("active")) this._isSliding = !1; else if (!this._triggerSlideEvent(l, o).defaultPrevented && r && l) {
                ...
                var i = L(t, "bs.carousel"), o = s({}, Z, q.getDataAttributes(t));
    ...
    var nt = "collapse", it = {toggle: !0, parent: ""}, ot = {toggle: "boolean", parent: "(string|element)"},
        st = function (t) {
            function e(e, n) {
                var i;
                ...
                for (var o = V.find('[data-bs-toggle="collapse"]'), s = 0, r = o.length; s < r; s++) {
                    var a = o[s], l = d(a), c = V.find(l).filter((function (t) {
                        return t === e
                    }));
            ...
            return n.toggle = function () {
                ...
                if (!this._isTransitioning && !this._element.classList.contains("show")) {
                    ...
                    if (!Q.trigger(this._element, "show.bs.collapse").defaultPrevented) {
                        ...
                        var a = "scroll" + (r[0].toUpperCase() + r.slice(1)), l = h(this._element);
                ...
                if (!this._isTransitioning && this._element.classList.contains("show") && !Q.trigger(this._element, "hide.bs.collapse").defaultPrevented) {
                    ...
                    if (n > 0) for (var i = 0; i < n; i++) {
                        var o = this._triggerArray[i], s = f(o);
                ...
                var i = L(t, "bs.collapse"), o = s({}, it, q.getDataAttributes(t), "object" == typeof n && n ? n : {});
    ...
    Q.on(document, "click.bs.collapse.data-api", '[data-bs-toggle="collapse"]', (function (t) {
        ...
        var e = q.getDataAttributes(this), n = d(this);
    ...
    var rt = "dropdown", at = new RegExp("ArrowUp|ArrowDown|Escape"), lt = T ? "top-end" : "top-start",
        ct = T ? "top-start" : "top-end", ut = T ? "bottom-end" : "bottom-start",
        dt = T ? "bottom-start" : "bottom-end", ft = T ? "left-start" : "right-start",
        ht = T ? "right-start" : "left-start", pt = {
            offset: 0,
            flip: !0,
            ...
            return a.toggle = function () {
                ...
                if (!this._element.disabled && !this._element.classList.contains("disabled") && this._menu.classList.contains("show")) {
                    var t = i.getParentFromElement(this._element), e = {relatedTarget: this._element};
                ...
                if (!t || 2 !== t.button && ("keyup" !== t.type || "Tab" === t.key)) for (var e = V.find('[data-bs-toggle="dropdown"]'), n = 0, o = e.length; n < o; n++) {
                    var s = i.getParentFromElement(e[n]), r = L(e[n], "bs.dropdown"), a = {relatedTarget: e[n]};
                    if (t && "click" === t.type && (a.clickEvent = t), r) {
                        var l = r._menu;
                        if (e[n].classList.contains("show")) if (!(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && "Tab" === t.key) && l.contains(t.target))) if (!Q.trigger(s, "hide.bs.dropdown", a).defaultPrevented) {
                            var c;
    ...
    var _t = {backdrop: !0, keyboard: !0, focus: !0},
        vt = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean"}, bt = function (t) {
            function e(e, n) {
                var i;
            ...
            return n.toggle = function (t) {
                ...
                var e = this, n = this._element.classList.contains("fade"), i = V.findOne(".modal-body", this._dialog);
    ...
    var At = "tooltip", Lt = new RegExp("(^|\\s)bs-tooltip\\S+", "g"),
        Ct = new Set(["sanitize", "allowList", "sanitizeFn"]), Dt = {
            animation: "boolean",
            template: "string",
        ...
        Nt = {
            ...
            return a.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    var n = Q.trigger(this._element, this.constructor.Event.SHOW), i = function t(e) {
                ...
                var e = this, n = {name: "flip", options: {altBoundary: !0}};
                ...
                var t = this.getTipElement(), e = t.getAttribute("class").match(Lt);
    ...
    var jt = "popover", Pt = new RegExp("(^|\\s)bs-popover\\S+", "g"), xt = s({}, It.Default, {
        placement: "right",
        trigger: "click",
        content: "",
        template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
    }), Ht = s({}, It.DefaultType, {content: "(string|element|function)"}), Bt = {
    ...
    var Rt = "scrollspy", Kt = {offset: 10, method: "auto", target: ""},
        Qt = {offset: "number", method: "string", target: "(string|element)"}, Ut = function (t) {
            function e(e, n) {
                var i;
            ...
            return n.refresh = function () {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), V.find(this._selector).map((function (t) {
                    var e = d(t), o = e ? V.findOne(e) : null;
                    if (o) {
    ...
    var Wt = function (t) {
        ...
        return n.show = function () {
            ...
            if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || this._element.classList.contains("disabled"))) {
                var e, n = f(this._element), i = this._element.closest(".nav, .list-group");
                if (i) {
    ...
    var Ft = {animation: "boolean", autohide: "boolean", delay: "number"},
        Yt = {animation: !0, autohide: !0, delay: 5e3}, zt = function (t) {
            function e(e, n) {
                var i;

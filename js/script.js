...
addNoteBtn.addEventListener('click', function () {
  const html = `<div
  class="card col-md-6 mx-2 my-2 note note ${mainNoteDivChild.children.length}"
  ...
  <div class="card-body">
    <div class="d-flex justify-content-center">
      ...
      <div class="visually-hidden">
        <span class="change-color"><i class="fa fa-chevron-left"></i></span>
    ...
    <label for=""></label>
    <textarea class="" name="" id="" cols="30" rows="8"></textarea>
